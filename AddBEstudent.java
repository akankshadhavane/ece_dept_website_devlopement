...
/**
 * Servlet implementation class AddBEstudent
 */
public class AddBEstudent extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			PreparedStatement ps = con.prepareStatement("insert into be_details values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			ps.setString(1, name);
			...
			ps.setString(16, ifccode);
			ps.setString(17, accountnumber);
